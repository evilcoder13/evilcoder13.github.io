...
const _sfc_main$4 = {
  ...
  methods: {
    urlSubmitted() {
      this.$emit("urlSubmit", this.urlInput);
    }
  }
};
const _hoisted_1$4 = /* @__PURE__ */ createBaseVNode("div", { id: "icon" }, "Tr", -1);
const _hoisted_2$3 = /* @__PURE__ */ createBaseVNode("i", { class: "icon ion-md-search" }, null, -1);
const _hoisted_3$3 = [
  _hoisted_2$3
];
function _sfc_render$2(_ctx, _cache, $props, $setup, $data, $options) {
  return openBlock(), createElementBlock(Fragment, null, [
    ...
    withDirectives(createBaseVNode("input", {
      "onUpdate:modelValue": _cache[0] || (_cache[0] = ($event) => _ctx.urlInput = $event),
      onKeyup: _cache[1] || (_cache[1] = withKeys((...args) => $options.urlSubmitted && $options.urlSubmitted(...args), ["enter"])),
      id: "url_input",
      type: "text",
      placeholder: "Adobe Fonts font family URL"
    }, null, 544), [
      [vModelText, _ctx.urlInput]
    ]),
    createBaseVNode("div", {
      id: "url_submit_button",
      onClick: _cache[2] || (_cache[2] = (...args) => $options.urlSubmitted && $options.urlSubmitted(...args))
    }, _hoisted_3$3)
  ], 64);
}
const SearchBar = /* @__PURE__ */ _export_sfc(_sfc_main$4, [["render", _sfc_render$2]]);
...
const _hoisted_1$3 = { class: "column" };
const _hoisted_2$2 = { class: "alertBox" };
const _hoisted_3$2 = { class: "info_container" };
...
const MessageBox = /* @__PURE__ */ _export_sfc(_sfc_main$3, [["render", _sfc_render$1]]);
const _sfc_main$2 = {
  name: "FontBox",
  ...
  created() {
    ...
    newStyle.appendChild(document.createTextNode("        @font-face {            font-family: '" + this.fontname + "';            src: url('" + this.fonturl + "');        }        "));
    document.head.appendChild(newStyle);
  }
};
const __injectCSSVars__ = () => {
  useCssVars((_ctx) => ({
    "2e677c3f": _ctx.fontname
  }));
};
const __setup__ = _sfc_main$2.setup;
_sfc_main$2.setup = __setup__ ? (props, ctx) => {
  __injectCSSVars__();
  return __setup__(props, ctx);
} : __injectCSSVars__;
const _withScopeId = (n) => (pushScopeId("data-v-1467776a"), n = n(), popScopeId(), n);
const _hoisted_1$2 = { class: "column four" };
const _hoisted_2$1 = { class: "item" };
const _hoisted_3$1 = { class: "upper" };
const _hoisted_4$1 = { class: "lower" };
const _hoisted_5$1 = { class: "info_container" };
const _hoisted_6$1 = ["href"];
const _hoisted_7$1 = { class: "small" };
const _hoisted_8$1 = { class: "button_container" };
const _hoisted_9$1 = /* @__PURE__ */ _withScopeId(() => /* @__PURE__ */ createBaseVNode("i", { class: "icon ion-md-arrow-down" }, null, -1));
const _hoisted_10 = [
  _hoisted_9$1
];
  ...
  return openBlock(), createElementBlock("div", _hoisted_1$2, [
    createBaseVNode("div", _hoisted_2$1, [
      createBaseVNode("div", _hoisted_3$1, [
        createBaseVNode("p", null, toDisplayString($props.sampletext), 1)
      ]),
      createBaseVNode("div", _hoisted_4$1, [
        createBaseVNode("div", _hoisted_5$1, [
          createBaseVNode("a", { href: $props.familyurl }, [
            createBaseVNode("p", null, toDisplayString($props.fontname), 1)
          ], 8, _hoisted_6$1),
          createBaseVNode("p", _hoisted_7$1, toDisplayString($props.fontstyle), 1)
        ]),
...
const FontBox = /* @__PURE__ */ _export_sfc(_sfc_main$2, [["render", _sfc_render], ["__scopeId", "data-v-1467776a"]]);
const _hoisted_1$1 = { class: "row" };
const _hoisted_2 = { class: "column" };
const _hoisted_3 = { class: "alertBox" };
const _hoisted_4 = { class: "info_container" };
const _hoisted_5 = {
  key: 0,
  class: "subtext"
};
...
const _hoisted_8 = { class: "button_container" };
          ...
          createBaseVNode("div", _hoisted_2, [
            createBaseVNode("div", _hoisted_3, [
              createBaseVNode("div", _hoisted_4, [
                createBaseVNode("h3", null, toDisplayString(__props.fontset.name), 1),
                __props.fontset.designers.length > 0 ? (openBlock(), createElementBlock("p", _hoisted_5, [
                  createTextVNode(" by "),
                  (openBlock(true), createElementBlock(Fragment, null, renderList(__props.fontset.designers, (designer, key) => {
                    return openBlock(), createElementBlock("span", null, [
                      createBaseVNode("a", {
                        href: designer.url
                      }, toDisplayString(designer.name), 9, _hoisted_6),
                      key < __props.fontset.designers.length - 1 ? (openBlock(), createElementBlock("span", _hoisted_7, ", ")) : createCommentVNode("", true)
                    ]);
                  }), 256))
              ...
              createBaseVNode("div", _hoisted_8, [
                createBaseVNode("a", {
                  class: "button",
                  onClick: _cache[0] || (_cache[0] = ($event) => _ctx.download(__props.fontset.fonts, __props.fontset.name))
                }, "Download All")
              ])
            ])
          ])
        ]),
        (openBlock(true), createElementBlock(Fragment, null, renderList(_ctx.getFontsInChunks(3), (chunk, c_key) => {
          return openBlock(), createElementBlock("div", _hoisted_9, [
            (openBlock(true), createElementBlock(Fragment, null, renderList(chunk, (font, f_key) => {
              return openBlock(), createBlock(FontBox, {
                key: c_key * 3 + f_key,
                onDownload: ($event) => _ctx.download([font], font.name),
                fontname: font.name,
                fontstyle: font.style,
                fonturl: font.url,
                sampletext: __props.fontset.sampletext,
                familyurl: font.familyUrl
              }, null, 8, ["onDownload", "fontname", "fontstyle", "fonturl", "sampletext", "familyurl"]);
            }), 128))
          ]);
        }), 256))
      ], 64);
...
class FontSet {
  constructor(name, designers, fonts, sample_text) {
    this.name = name;
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock(Fragment, null, [
        createBaseVNode("header", null, [
          createVNode(SearchBar, { onUrlSubmit: _ctx.submit_url }, null, 8, ["onUrlSubmit"])
        ]),
        createBaseVNode("article", null, [
          createBaseVNode("div", _hoisted_1, [
            _ctx.message_is_visible ? (openBlock(), createBlock(MessageBox, {
              key: 0,
              title: _ctx.message_title,
              htmlContent: _ctx.message_text
            }, null, 8, ["title", "htmlContent"])) : createCommentVNode("", true),
            _ctx.active_font_group ? (openBlock(), createBlock(_sfc_main$1, {
              key: 1,
              fontset: _ctx.active_font_group,
              onDownload: _ctx.download
            }, null, 8, ["fontset", "onDownload"])) : createCommentVNode("", true)
          ])
        ])
      ], 64);
    };
